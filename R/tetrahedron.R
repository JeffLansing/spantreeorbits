...
#' Translate the tetrahedron coordinates from the polyhedronisme OBJ output into
#' R code
#'
...
get_tetrahedron <- function() {
  path <- system.file("extdata", "polyhedronisme-T.obj", package = "spantreeorbits", mustWork = TRUE)
