...
```{r echo=FALSE, fig.align='center', fig.cap=c("Figure 1. A tree of polyhedra with names, Conway operators, and edges/faces/vertices counts."), fig.height=4, fig.width=6}
...
poly_info <- cbind(
  ...
  c('8/12/6','14/24/12','24/48/26','48/96/50','4/6/4','6/12/8','12/24/14','26/48/24','4/6/4') # Euler
