...
#Look at one of the pairs, e.g., the first one
tree <- s13s11trees[1,]
...
So this gives a representation of the tree pair as a vector of zeros and ones.
...
The 331776 spanning tree pairs for the rhombic dodecahedron and the  cuboctahedron will .use slightly less than 2 percent of these representations.
