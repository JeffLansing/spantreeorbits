...
```{r display1, fig.align='center', fig.cap=c("Figure 1. A tetrahedron and its dual, with some spanning trees, as red edges.")}
display_tree_pairs(tetrahedron, dual_tetrahedron, rhombic_dodecahedron, reps, c(1,13,2,3))
