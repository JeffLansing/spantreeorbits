...
<center>
![Trees with 8 vertices](./images/harary.png){#id .class width=75% height=75%}
</center>
...
Of these 23 trees, only 5 will span a cube: the first, third, and fourth trees in the first row of the figure, the seventh tree in the second row, and the first 2 trees in the third row of the figure. Following the [ISGCI nomenclature](https://www.graphclasses.org/smallgraphs.html#nodes8) this 5 trees are named, in order,
...
\begin{array}{|c|c|c|c|c|}
  ...
  \hline
  2 & star_{1,2,4} & P_3\cup P_4 & P_6 & X_{37} \\
  \hline 
  6 & H_3 & P_6\cup K_1 & P_6 & 2K_3+e \\
  \hline
  9 & P_8 & 2P_2\cup P_4 & P_6 & \textit{twin-}C_5 \\
  \hline 
  3 & star_{1,2,4} & P_3\cup P_4\cup K_1 & star_{1,1,3} & \overline{X_5} \\
  \hline
  5 & _{1,3}^{1,1}H_1 & P_6 & star_{1,1,3} & X_{171} \\
  \hline
  11 & P_8 & P_4\cup 2P_2 & star_{1,1,3} & X_{45} \\
  \hline 
  7 & star_{2,2,3} & P_5\cup P_2 & star_{1,2,2} & antenna \\
  \hline 
  8 & star_{1,2,4} & P_5\cup P_2\cup K_1 & star_{1,2,2} & \overline{X_5} \\
  \hline
  18 & ^{1,1}_{2,2}H_1 & P_6 & H_1 & \textit{co-twin-house} \\
  \hline
  13 & ^{1,1}_{2,2}H_1 & C_4\cup K_2 & star_{1,1,1,2} & X_{170}\textit{-e}\cup K_1 \\
  \hline
\end{array}
\]
